...
// Fusion
resaver.fuseDataset( )
resaver.logtrace.each{ println it }
	...
	def fuseDataset() {
		...
		if( settings.bigstitcher.fusion_parameters.fusion_type == "fast" ) {
            ...
            IJ.run("Fuse a BigStitcher dataset to OME-Tiff",
                    ...
                    "output_path_directory=[" + settings.general_parameters.output_dir + "] " +
                    "range_channels= " +
                    "range_slices= " +
                    "range_frames= " +
            ...
            IJ.run("Fuse dataset ...",
                    ...
                    "output_file_directory=[" + settings.general_parameters.output_dir + "] " +
                    "filename_addition=[" + settings.bigstitcher.fusion_parameters.filename_addition + "]")
